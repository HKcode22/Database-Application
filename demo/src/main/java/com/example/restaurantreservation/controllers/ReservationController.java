...
import com.example.restaurantreservation.models.Reservation;
...
public class ReservationController {
    ...
    public ResponseEntity<List<Reservation>> viewReservations(@PathVariable int customerId) {
    ...
    public ResponseEntity<String> modifyReservation(@PathVariable int reservationId, 
        ...
        boolean success = reservationService.updateReservation(reservationId, newReservationDate, newReservationTime);
        if (success) {

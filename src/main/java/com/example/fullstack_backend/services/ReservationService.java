...
import com.example.fullstack_backend.repository.ReservationRepository;
...
public class ReservationService {
    ...
    public boolean modifyReservation(int reservationId, String newReservationDate, String newReservationTime) {

...
public class RestaurantResource {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<RestaurantDTO>> searchRestaurants(@RequestParam String name, @RequestParam String location) {
        return ResponseEntity.ok(restaurantService.searchRestaurants(name, location));
    }
